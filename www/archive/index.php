...
<body>
    ...
    <div id="top" class="header">
        <div class="text-center">
            <h1>Archív Volebných kalkulačiek</h1>
        </div>
        <div class="container">
            <div class="alert alert-warning" role="alert">
                Upozornenie: Niektoré staršie Volebné kalkulačky nemusia fungovať, z dôvodu prechodu z <em>http</em> na <em>https</em>.
            </div>
            ...
            <div class="alert alert-success" role="alert">
                <a href="https://github.com/michalskop/datapackages" class="alert-link">Dáta z volebných kalkulačiek</a>.

        </div>
            <div class="alert alert-success" role="alert">
                <a href="https://volebnikalkulacka.cz/archive/" class="alert-link">Archív českých Volebných kalkulačiek</a>.
            </div>
        </div>
    </div>
